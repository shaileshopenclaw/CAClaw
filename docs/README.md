...
This folder explains CAClaw in plain language.

If you are a Chartered Accountant or a team member using CAClaw, start here.

## Best reading order

1. [`../README.md`](../README.md) — what CAClaw does and how to install it
...
### Brand and maintainer reference
...
- [`customization-seams.md`](customization-seams.md)
- [`upstream-baseline.md`](upstream-baseline.md)
- [`upstream-sync.md`](upstream-sync.md)
- [`ux-language-map.md`](ux-language-map.md)
